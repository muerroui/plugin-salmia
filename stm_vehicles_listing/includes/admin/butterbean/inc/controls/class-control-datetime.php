...
class ButterBean_Control_Datetime extends ButterBean_Control {
	...
	public function to_json() {
		...
		$this->json['year'] = array(
			'value' => esc_attr( $year ),
			'label' => esc_html__( 'Year', 'stm_vehicles_listing' ),
		...
		$this->json['month'] = array(
			...
			'label'   => esc_html__( 'Month', 'stm_vehicles_listing' ),
			'choices' => array(
				array(
					'num'   => '',
					'label' => ''
		...
		$this->json['day'] = array(
			...
			'label' => esc_html__( 'Day', 'stm_vehicles_listing' ),
		...
		$this->json['hour'] = array(
			...
			'label' => esc_html__( 'Hour', 'stm_vehicles_listing' ),
		...
		$this->json['minute'] = array(
			...
			'label' => esc_html__( 'Minute', 'stm_vehicles_listing' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
		...
		$this->json['second'] = array(
			...
			'label' => esc_html__( 'Second', 'stm_vehicles_listing' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
	}
}
