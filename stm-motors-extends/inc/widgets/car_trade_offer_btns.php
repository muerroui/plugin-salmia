...
class STM_Car_Trade_Offer_Btns extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'stm_car_trade_offer_btns', 'description' => __('STM Car Trade and Offer Btns', 'stm_motors_extends'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('stm_car_trade_offer_btns', __('STM Car Trade and Offer Btns', 'stm_motors_extends'), $widget_ops, $control_ops);
	}
