	...
	public function __construct( $manager, $name, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			...
			array(
				...
				'set'         => esc_html__( 'Set as image',      'stm_vehicles_listing' ),
				'choose'      => esc_html__( 'Choose image',      'stm_vehicles_listing' ),
				'change'      => esc_html__( 'Change image',      'stm_vehicles_listing' ),
				'remove'      => esc_html__( 'Remove image',      'stm_vehicles_listing' ),
				'placeholder' => esc_html__( 'No image selected', 'stm_vehicles_listing' )
			)
		);
	}
