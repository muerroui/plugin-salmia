...
class ButterBean_Control {
	...
	public function to_json() {
        ...
        if(get_the_ID() != stm_get_wpml_product_parent_id(get_the_ID()) && get_post_status() != 'auto-draft') {

		    if($this->name == 'cars_qty') {
                $this->json['label'] .= ' (This field are not editable.)';
                $carsQty = get_post_meta( stm_get_wpml_product_parent_id( get_the_ID() ), 'cars_qty', true );
